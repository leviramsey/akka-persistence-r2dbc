...
-- To distribute with Citus/CosmosDB Postgres
SELECT create_distributed_table('event_journal', 'persistence_id');
...
-- To distribute with Citus/CosmosDB Postgres
SELECT create_distributed_table('snapshot', 'persistence_id');
...
-- To distribute with Citus/CosmosDB Postgres
SELECT create_distributed_table('durable_state', 'persistence_id');
...
-- To distribute with Citus/CosmosDB Postgres
SELECT create_distributed_table('akka_projection_offset_store', 'projection_name');
...
-- To distribute with Citus/CosmosDB Postgres
SELECT create_distributed_table('akka_projection_timestamp_offset_store', 'slice');
...
-- To distribute with Citus/CosmosDB Postgres
SELECT create_distributed_table('akka_projection_management', 'projection_name');
